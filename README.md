...
In order to use this API, you need to generate a Belgium Post Tracking  API key in the [TrackingMore](https://www.trackingmore.com).
...
------------------------------------------------------------------------------------------------------------------
[TrackingMore](https://www.trackingmore.com) is a multiple carrier solutions. Developers can get tracking results from 410+ couriers by integrating trackingmore API.Check the courier code.  use  Belgium Post Tracking API of Trackingmore  allows eCommerce developers in any sizes to add package tracking fuction easily. Use [Belgium Post Tracking API](https://www.trackingmore.com/belgium-post-tracking.html)  to:

   *   Get Belgium Post realtime tracking info of muti-carriers in one integration
   *   Provide Belgium Post shipment tracking experience like Amazon
   *   Push Belgium Post  notifications of package update with webhook
   *   Verify Belgium Post delivery exception before it is too late
